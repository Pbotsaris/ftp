...
struct PathHelpers {
  ...
  static std::string join_to_user_path(const networking::Request &t_req,
                                       const std::string path_to_join);
  static std::string join_to_system_path(const networking::Request &t_req,
                                         const std::string path_to_join);
  static std::string create_system_root_path();
  static std::string add_to_path(const std::string &t_path,
                                 const std::string &t_path_to_add);
